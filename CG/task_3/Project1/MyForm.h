...
#pragma endregion
	private: System::Void MyForm_Paint(System::Object^ sender, System::Windows::Forms::PaintEventArgs^ e)
	{
		...
		mat3 M = T * initT; // совмещение начального преобразования и накопленных преобразований
	...
	private: System::Void MyForm_KeyDown(System::Object^ sender, System::Windows::Forms::KeyEventArgs^ e)
	{
		...
		case Keys::T:
			...
			break;
		case Keys::G:
			T = translate(0.f, 10.f) * T; // сдвиг вниз на 10
			break;
		case Keys::F:
			T = translate(-10.f, -0.f) * T; // сдвиг влево на 10
			break;
		case Keys::H:
			T = translate(10.f, 0.f) * T; // сдвиг вправо на 10
			break;
		case Keys::Q:
